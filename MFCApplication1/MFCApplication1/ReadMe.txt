...
MFCApplication1.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CMCAApp 应用程序类。

MFCApplication1.cpp
    这是包含应用程序类 CMCAApp 的主应用程序源文件。
...
MFCApplication1Doc.h、MFCApplication1Doc.cpp - 文档
    这些文件包含 CMCADoc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 CMCADoc::Serialize）。

MCAView.h、MCAView.cpp - 文档视图
    这些文件包含 CMCAView 类。
    CMCAView 对象用于查看 CMCADoc 对象。
